  ...
  <div id="app">
    ...
    <!--<div v-if="!aut.hasAccess" class="container-12 d-flex justify-content-md-center">-->
        ...
        <!--<div id="authpage" class="col-12 col-md-8 col-lg-6"  >-->
          ...
          <!--&lt;!&ndash;<a class="p-2" :href="this.vk_link"><img id="vk" src="./img/vkcom.svg" ></a>&ndash;&gt;-->
          <!--&lt;!&ndash;<a class="p-2" @click="listLabels" id="authorize_button"  href="#"><img src="./img/google.jpg" width="50px" height="50px" ></a>&ndash;&gt;-->

            <!--&lt;!&ndash;&lt;!&ndash;Add buttons to initiate auth sequence and sign out&ndash;&gt;&ndash;&gt;-->
            <!--&lt;!&ndash;<button id="authorize_button" style="d-->
            <!--isplay: none;">Authorize</button>&ndash;&gt;-->


            <!--&lt;!&ndash;<button id="signout_button" style="display: none;">Sign Out</button>&ndash;&gt;-->


            <!--&lt;!&ndash;<pre id="content" style="white-space: pre-wrap;"></pre>&ndash;&gt;-->


            <!--&lt;!&ndash;<script async defer src="https://apis.google.com/js/api.js"&ndash;&gt;-->
                    <!--&lt;!&ndash;onload="this.onload=function(){};handleClientLoad()"&ndash;&gt;-->
                    <!--&lt;!&ndash;onreadystatechange="if (this.readyState === 'complete') this.onload()">&ndash;&gt;-->
            <!--&lt;!&ndash;</script>&ndash;&gt;-->
  ...
  data(){
    {
      ...
      //          .then((response) => {
      //            appendPre(JSON.stringify(response));
      //            alert('pi')
      //          });
